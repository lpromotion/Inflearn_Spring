...
connect: http://hello-spring.dev
call: http://hello-spring.dev message: 초기화 연결 메시지
23:45:38.863 [Test worker] DEBUG o.s.c.a.AnnotationConfigApplicationContext -- Closing org.springframework.context.annotation.AnnotationConfigApplicationContext@f001896, started on Sat Jan 27 23:45:38 KST 2024
NetworkClient.close
close http://hello-spring.dev
```
...
- 패키지를 잘 보면 `jakarta.annotation.PostConstruct`이다. 스프링에 종속적인 기술이 아니라 JSR-250 라는 자바 표준(인터페이스 모음)이다. 따라서 스프링이 아닌 다른 컨테이너에서도 동작한다.
- 컴포넌트 스캔과 잘 어울린다.
